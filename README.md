...
这是一个静态可视化选品系统，从家清个护、日化纸品方向的 40 个具体 SKU 池中，每天轮换展示 10 个候选。每个推荐项必须是单一品牌、单一规格、可追溯源商品链接的具体 SKU，并展示商品图片、各平台参考低价、公开销量/评论信号、建议售价、1688 单 SKU 最低价状态、预计毛利率和 1-10 分综合热度评分。
